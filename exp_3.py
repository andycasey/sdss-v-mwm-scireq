...
[X] Train a restricted Cannon model without cross-terms.
...
model.write(os.path.join(OUTPUT_PATH, "restricted_wo_ct.model"), overwrite=True)
...
fig.savefig(os.path.join(OUTPUT_PATH, "baseline_wo_ct_theta.pdf"), dpi=300)
...
fig.savefig(os.path.join(OUTPUT_PATH, "baseline_wo_ct_one_to_one.pdf"))
...
with open(os.path.join(OUTPUT_PATH, "baseline_wo_ct_precision_snr.pkl"), "wb") as fp:
