...
model_with_bounds.write(os.path.join(FIGURE_PATH, "model_with_bounds.model"))
...
fig.savefig(os.path.join(FIGURE_PATH, "restricted_theta.pdf"), dpi=300)
...
fig.savefig(os.path.join(FIGURE_PATH, "restricted_one_to_one.pdf"), dpi=300)


# TODO: Run on individual visits.
...
model_wo_ct.write(os.path.join(FIGURE_PATH, "model_wo_ct.model"))
...
fig.tight_layout()
fig.subplots_adjust(hspace=0, wspace=0)
fig.savefig(os.path.join(FIGURE_PATH, "wo_ct_theta.pdf"), dpi=300)
...
fig.set_figheight(40)
fig.subplots_adjust(wspace=0, hspace=0)
fig.savefig(os.path.join(FIGURE_PATH, "wo_ct_one_to_one.pdf"), dpi=300)

# TODO: Run on all individual visits.
...
model_wb_and_wo_ct.write(os.path.join(FIGURE_PATH, "model_wb_and_wo_ct.model"))

# Plot all theta.
fig = tc.plot.theta(model_wb_and_wo_ct)
fig.set_figheight(20)
fig.tight_layout()
fig.subplots_adjust(hspace=0, wspace=0)
fig.savefig(os.path.join(FIGURE_PATH, "wb_and_wo_ct_theta.pdf"), dpi=300)
...
fig.set_figheight(40)
fig.subplots_adjust(wspace=0, hspace=0)
fig.savefig(os.path.join(FIGURE_PATH, "wb_and_wo_ct_one_to_one.pdf"), dpi=300)

# TODO: Run on all individual visits and plot dispersion as a function of S/N.
