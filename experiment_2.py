...
model.write(os.path.join(OUTPUT_PATH, "aspcap_censored.model"),
            overwrite=True)
...
fig.savefig(os.path.join(OUTPUT_PATH, "aspcap_censored_restricted_theta.pdf"), dpi=300)
...
fig.savefig(os.path.join(OUTPUT_PATH, "aspcap_censored_restricted_one_to_one.pdf"), dpi=300)
...
with open(os.path.join(OUTPUT_PATH, "aspcap_censored_precision_snr.pkl"), "wb") as fp:
